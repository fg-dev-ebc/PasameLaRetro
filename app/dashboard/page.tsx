...
export default async function DashboardPage() {
  ...
  const [equipment, bookings] = await Promise.all([getOwnerEquipment(), getBookingsForUser()])
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-px bg-border md:grid-cols-3">
        <Metric title="Publicaciones" value={equipment.length} icon={Truck} />
        <Metric title="Reservas recibidas" value={received.length} icon={CalendarCheck} />
